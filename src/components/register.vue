<template>
    <div class="relative min-h-screen">
        <div  class=" bg-white-100 border-2 border-gray-100 rounded p-4 pl-8 pr-8 max-w-sm flex flex-col items-center r-center shadow">
            ...
            <form class="flex flex-col justify-center items-start">
                ...
                <input  class="input w-64 h-10 bg-blue-600 text-white rounded mt-6 mb-2 cursor-pointer shadow outline-none border-none" id="submit" type="submit" value="Sign up" @click.prevent="register()">
            </form>
            <p v-if="error" class="text-xs text-red-400 mt-2 mb-2">Username already exist</p>
            ...
            <div class="flex flex-col justify-center items-center mt-6 mb-2">
                <p class="text-xm">Already have an account?</p>
...
export default {
    ...
    methods: {
        register(){
            ...
            axios.post('https://chatify-back.herokuapp.com/auth/signup', data)
            .then((response) => {
                if(response){
